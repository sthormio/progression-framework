    ...
    content:
      ...
      - level: 4
        criteria:
          ...
          - "Instills Sthorm engineering principles in other engineers"
    ...
    content:
      ...
      - level: 5
        criteria:
          ...
          - "Given as reason for other engineers to join Sthorm"
    ...
    content:
      ...
      - level: 5
        criteria:
          ...
          - "Contributes to maintaining Sthorm’s culture in the wider company"
